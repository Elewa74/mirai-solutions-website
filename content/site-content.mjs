...
const en = {
  ...
  consult: {
    ...
    submit: "Send request",
    sending: "Sending…",
    privacy: "We use these details only to review your request and reply to you — nothing else. No cookies, no tracking of individuals.",
    autoReply: { subject: "We received your request — Mirai Solutions", body: "Hello,\n\nThank you for contacting Mirai Solutions. We have received your consultation request and will reply within one working day with a practical next step.\n\nIf anything is urgent, simply reply to this email.\n\nMirai Solutions\nPractical digital solutions built around real business needs.\nhttps://miraisolutions.net" },
    close: "Close",
    ...
    states: {
      ...
      success: { title: "Your request has been sent.", body: "Thank you — we've received your details and will reply within one working day with a practical next step.", whatsapp: "Prefer WhatsApp? You can also continue there now." },
...
const ar = {
  ...
  consult: {
    ...
    privacy: "نستخدم هذه البيانات فقط لمراجعة طلبك والرد عليك — لا غير. بلا كوكيز ولا تتبّع للأفراد.",
    autoReply: { subject: "وصلنا طلبك — Mirai Solutions", body: "مرحبًا،\n\nشكرًا لتواصلك مع Mirai Solutions. وصلنا طلب الاستشارة الخاص بك وسنرد عليك خلال يوم عمل واحد بخطوة عملية تالية.\n\nإن كان الأمر عاجلًا، يكفي أن ترد على هذا البريد.\n\nMirai Solutions\nحلول رقمية عملية تُبنى حول احتياجات عملك الحقيقية.\nhttps://miraisolutions.net" },
    close: "إغلاق",
    ...
    states: {
      ...
      success: { title: "تم إرسال طلبك بنجاح.", body: "شكرًا لك — وصلتنا بياناتك وسنرد عليك خلال يوم عمل واحد بخطوة عملية تالية.", whatsapp: "تفضّل واتساب؟ يمكنك المتابعة هناك الآن أيضًا." },
